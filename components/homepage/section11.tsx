...
const HomeSection11 = () => {
    return (
        <section className="w-full mx-auto flex flex-col items-center justify-between py-16">
            <div className="h-[380px] md:h-[550px] w-full overflow-hidden relative">
            ...
            <div className="flex flex-col md:flex-row w-full justify-center items-center bg-[#BF9B30]">
                <div className="h-[380px] md:h-[480px] md:w-1/2 w-full relative">
                ...
                <div className="flex flex-col gap-8 md:w-1/2 px-16 w-full z-10">
                    <div className="flex flex-col gap-4 ">
                        <p className=" w-16 h-16 bg-[#9690a226] p-4 rounded-full flex items-center justify-center">
                            <ChatsIcon size={32} weight="fill" className="rounded-lg" />
                        </p>
