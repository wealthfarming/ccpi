    ...
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <div className="w-[70%] mx-auto max-w-7xl px-4 py-8">
        <div className="space-y-6">
          ...
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
            <strong>IMPORTANT</strong>: PLEASE REVIEW THE MUTUAL ARBITRATION CLAUSE SET FORTH BELOW CAREFULLY, AS IT WILL REQUIRE YOU TO RESOLVE DISPUTES WITH CCPI THROUGH FINAL AND BINDING ARBITRATION. BY ENTERING THIS AGREEMENT , YOU EXPRESSLY ACKNOWLEDGE THAT YOU HAVE READ AND UNDERSTAND ALL OF THE TERMS OF THIS MUTUAL ARBITRATION CLAUSE.
          </p>

          <h2 className="text-3xl font-bold">1. Age and Eligibility</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">2. Temporary Use License</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">3. Your Content</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">4. Free Plan</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">5. Acceptable Use</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.1. The Services may only be used for lawful purposes.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.2. You shall not attempt to undermine the security or integrity of computing systems or networks of CCPI or of any other persons or entities, and must not attempt to gain unauthorized access to any such systems or networks.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.3. You shall not attempt to contribute to or enable the selling or movement of illegal goods and services.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.4. The Services and/or CCPI’s network resources may not be used to impersonate another person or entity, or to misrepresent authorization to act on behalf of another person or entity, including CCPI.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.5. You must not introduce software or automated agents or scripts into CCPI’s website in order to produce multiple accounts, generate automated searches, requests or queries, or to strip or mine content or data from CCPI’s website.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.6. You must not circumvent or otherwise misuse CCPI’s limits or usage guidelines, as described in Section 9 (Usage Restrictions) and CCPI’s Fair Use Guidelines, including by creating multiple accounts.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.7. You must not access CCPI’s websites through automated methods, including any use of robots or other computer code which calls CCPI’s website.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.8. You shall not send unsolicited messages, use the Services to send unsolicited messages (also known as junk mail or SPAM), or create spammy content, including ‘clickbait’ or ‘clickfraud’ schemes, in each case as determined by CCPI in its sole discretion.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.9. Your use of the Services must not involve any synthetic media or materials (“deepfakes”) that promote any type of illegal activity, including, without limitation, any child sexual exploitation or child sexual abuse.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.10. You shall not use the Services to reproduce the functionality of CCPI Services, including any storage products.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.11. You shall not use the Services as a remote storage server or for the primary purpose of providing downloadable content.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.12. You may not rent, lease, loan, or sell access to, or otherwise attempt to transfer any right in CCPI’s website (which includes its software and Documentation) to a third-party, through framing or any other method.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.13. You may not engage in any name-squatting behavior within CCPI namespaces such as usernames, team names, or deployment URLs; attempt to resell, barter, or trade names; or inactively hold names for future use.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.14. You must not interfere with or disrupt the Services or create an undue burden on CCPI’s website or the networks or services connected to CCPI’s website.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.15. You may not use the Services or CCPI’s infrastructure for proxying, scraping, to create virtual private networks, or to create virtual private servers.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>5.16. You may conduct benchmark tests on our Services, subject to any restrictions in this Section 5 (Acceptable Use). If you publicly disclose the results of any benchmark tests performed by you, or a third party on your behalf, the results must include all necessary information for others to replicate the tests.</p>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">6. Etiquette</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">7. Security and Compliance</h2>
          <h3 className="text-2xl font-bold">7.1 General</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">7.2 PCI Compliance</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">7.3 HIPAA Compliance</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">8. Data Protection</h2>
          <h3 className="text-2xl font-bold">8.1 International Transfers of Data</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">8.2 Use of Your Data</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">8.3 Aggregate Data</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">9. Usage Restrictions</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
            You will not, directly or indirectly: 
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>(i) sublicense, resell, rent, lease, transfer, assign, or otherwise commercially exploit or make the Services available to any third party; </li>
            <li style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>(ii) reverse engineer, decompile, disassemble or otherwise attempt to discover the source code, object code or underlying structure, ideas, know-how or algorithms relevant to the Services or any software, documentation or data related to the Services (where reverse engineering is permitted by applicable law obtaining such information as is necessary to achieve interoperability with CCPI’s services, you must first request such information from CCPI); </li>
            <li style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>(iii) modify, translate, or create derivative works based on the Services (except to the extent expressly permitted by CCPI or authorized within the Services) or otherwise attempt to gain unauthorized access to the Services or its related systems or networks; </li>
            <li style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>(iv) use the Services for timesharing or service bureau purposes or otherwise for the benefit of a third-party; or remove any proprietary notices or labels; </li>
            <li style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>(v) remove, alter or obscure in any way any proprietary rights notices (including copyright notices) of CCPI or its suppliers on or within the Services or documentation; </li>
            <li style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>(vi) violate any applicable laws or regulations (including without limitation in violation of any data, privacy or export control laws) or infringe the rights of any third-party in connection with the use or access of the Services. You shall comply with any codes of conduct, policies or other notices, CCPI provides you or publishes in connection with the Services, and you shall promptly notify CCPI if you learn of a security breach or issue related to the Services. Without limiting the foregoing, you acknowledge that CCPI may establish general practices and limits concerning use of the Services, including without limitation the maximum period of time that data, code or other content will be retained by the Services, the maximum storage space that will be allotted on CCPI’s servers on your behalf, and the maximum compute capacity provided for the execution of builds and functions and the maximum network data transferred by the Services. You further acknowledge that CCPI reserves the right to change these general practices and limits at any time, in its sole discretion. CCPI’s DMCA Policy is incorporated by reference into this Agreement.</li>
          </ul>

          <h2 className="text-3xl font-bold">10. Support</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">11. Electronic Communications</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">12. Representation and Warranties</h2>
          <h3 className="text-2xl font-bold">12.1 Representations</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
            You represent and warrant that 
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>(i) you own all Your Content or have obtained all permissions, releases, rights or licenses required to engage in posting and other activities (and allow CCPI to perform its obligations) in connection with the Services without obtaining any further releases or consents; </li>
            <li style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>(ii) Your Content and other activities in connection with the Services, and CCPI’s exercise of all rights and license granted by you herein, do not and will not violate, infringe, or misappropriate any third party’s copyright, trademark, right of privacy, or publicity, or other personal or proprietary right and Your Content is not defamatory, obscene, unlawful, threatening, abusive, tortious, offensive or harassing; and </li>
            <li style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>(iii) you will use the Services only in compliance with CCPI’s standard published policies and documentation then in effect and all applicable laws and regulations.</li>
          </ul>
          <h3 className="text-2xl font-bold">12.1 Mutual Warranty</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">13. Indemnification</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">14. Confidentiality; Proprietary Rights</h2>
          <h3 className="text-2xl font-bold">14.1 Confidentiality</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">14.2 Company Ownership</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">14.3. Feedback</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">14.4. Customer Name</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">15. Payment of Fees</h2>
          <h3 className="text-2xl font-bold">15.1. Plans</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">15.2. Payments</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">16. Term and Termination</h2>
          <h3 className="text-2xl font-bold">16.1. Term</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">16.2. Survival</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">16.3. Effect of Termination</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">17. Disclaimer</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">18. Limitation of Liability</h2>
          <h3 className="text-2xl font-bold">18.1. Limit of Liability and Waiver of Consequential Damages</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h3 className="text-2xl font-bold">18.2. Limits</h3>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
          ...
          <h2 className="text-3xl font-bold">19. Miscellaneous</h2>
          <p style={{ fontSize: '18px', textTransform: 'none', color: '#000000' }}>
