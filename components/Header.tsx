    ...
    <header className="bg-[#254099] text-white py-4 px-6 sticky top-0 z-50">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Link href="https://ccpi.vn/" className="flex items-center space-x-3">
            <Image 
              fetchPriority="high" 
        ...
        <nav className="flex items-center space-x-8">
            ...
            {isProductsOpen && (
              <div className="absolute top-full left-0 mt-0 w-96 z-50">
                ...
                <div className="bg-gray-100 shadow-lg">
                  <Link href="https://ccpi.vn/products/beq-top-5-exchanges-index/" className="block px-6 py-4 text-[#2B4FBB] hover:bg-gray-200 transition-colors font-medium">
                    BEQ TOP 5 EXCHANGES INDEX
                  </Link>
                  <Link href="https://ccpi.vn/products/indexes-review-strategy-index-2/" className="block px-6 py-4 text-[#2B4FBB] hover:bg-gray-200 transition-colors font-medium">
                    INDEXES REVIEW STRATEGY INDEX
                  </Link>
                  <Link href="https://ccpi.vn/products/dynamic-multi-asset-tradable-index/" className="block px-6 py-4 text-[#2B4FBB] hover:bg-gray-200 transition-colors font-medium">
                    DYNAMIC MULTI ASSET TRADABLE INDEX
                  </Link>
                  <Link href="https://ccpi.vn/products/blockchain-etf-tradable-index/" className="block px-6 py-4 text-[#2B4FBB] hover:bg-gray-200 transition-colors font-medium">
                    BLOCKCHAIN ETF TRADABLE INDEX
                  </Link>
                  <Link href="https://ccpi.vn/products/women-ceo-usa-tradable-index/" className="block px-6 py-4 text-[#2B4FBB] hover:bg-gray-200 transition-colors font-medium">
                    WOMEN CEO USA TRADABLE INDEX
                  </Link>
                  <Link href="https://ccpi.vn/products/beq-top-10-sports-index/" className="block px-6 py-4 text-[#2B4FBB] hover:bg-gray-200 transition-colors font-medium">
          ...
          <Link href="https://ccpi.vn/legal-term-of-service/" className="text-white hover:text-blue-200 transition-colors font-medium">
            Terms of Service
          </Link>
          <Link href="https://ccpi.vn/faqs/" className="text-white hover:text-blue-200 transition-colors font-medium">
            FAQs
          </Link>
          <Link href="https://ccpi.vn/contact/" className="text-white hover:text-blue-200 transition-colors font-medium">
            Contact
          </Link>
