    ...
    <div className="max-w-[1200px] mx-auto mb-20">
      ...
      <div className="flex flex-col md:flex-row mt-20">
        ...
        <div className="w-full md:w-2/3 pb-[35px]">
          <div className="text-left text-[17px] pb-0">
            <p>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-2/3 pb-[35px]">
          <div className="text-left text-[17px] pb-[6px]">
            <p>
          ...
          <div className="pb-[10px]">
            <ul>
              <li className=" flex items-center py-2">
                ...
                <span className="text-[17px] ml-4">Amet Sollicitudin Quam Dolor Mollis</span>
              </li>
              <li className=" flex items-center py-2">
                <div
                  className={`w-4 h-4 rounded-full transition-all duration-300 relative border-2 border-[#313787]`}
                ...
                <span className="text-[17px] ml-4">Diipiscing Vestibulum Nullam Venenatis</span>
              </li>
              <li className=" flex items-center py-2">
                <div
                  className={`w-4 h-4 rounded-full transition-all duration-300 relative border-2 border-[#313787]`}
              ...
              <li className=" flex items-center py-2">
                ...
                <span className="text-[17px] ml-4">Vehicula Vulputate Ligula Mollis</span>
              </li>
            </ul>
          </div>
        </div>
...
export default BusinessProjectSectionsComponent;