// components/HelpMonitoringComponent.tsx

import React from 'react';

const HelpMonitoringComponent: React.FC = () => {
  return (
    <div className="pt-[20px] pb-[30px]">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 bg-cover bg-center bg-fixed ml-0 md:ml-[40px]" style={{ backgroundImage: `url(https://ccpi.vn/wp-content/uploads/2017/09/shutterstock_245508985.jpg)` }}>
        </div>
      </div>
    </div>
  );
...
export default HelpMonitoringComponent;