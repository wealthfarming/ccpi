      ...
      <Header />
        ...
        <div className="container mx-auto px-4">
          <nav className="text-sm text-blue-600">
            ...
            &gt; <a href={`https://ccpi.vn/portfolio/merger-acquisition`} className="hover:underline">Merger & Acquisition</a> &gt;<span className="text-gray-600 p-2">Merger & Acquisition</span>
          </nav>
        </div>
      <PortfolioComponent />
